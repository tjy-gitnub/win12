                            ...
                            cnt.forEach(cn => {
                                if (cn.name == 'app.json') {
                                    $.getJSON('https://tjy-gitnub.github.io/win12-msstore/' + cn.path).then(inf => {
                                        ...
                                        $('#msstore-apps')[0].innerHTML = $('#msstore-apps')[0].innerHTML + '<div class="card"><center><img src="' + inf['icon'] + '" width="82px" height="82px"/></center><center class="title">' + inf['name'] + '</center><center class="download" id="open" onclick="openapp(\'' + inf['name'] + '\');"><span>打开</span></center></div>';
